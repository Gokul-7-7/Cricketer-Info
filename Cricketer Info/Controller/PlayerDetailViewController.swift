...
//        playerImageView.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 8).isActive = true
//        playerImageView.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: 8).isActive = true
    ...
    func setupPlayerNameLabelConstraints() {
        ...
        playerNameLabel.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 16).isActive = true
        playerNameLabel.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: 16).isActive = true
